...
// ✅ Required for output: "export" so Next can prebuild /projects/chatbot, /projects/assistant, /projects/voting
...
const demoMap: Record<(typeof projects)[number]["slug"], React.ReactNode> = {
    chatbot: <ChatbotDemo />,
