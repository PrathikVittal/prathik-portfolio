...
function SkillInline({ item }: { item: SkillItem }) {
  ...
  return (
    <div className="flex items-center gap-4 px-2 py-1 text-zinc-800">
      <Icon className="h-5 w-5 text-zinc-500" />
      <span className="text-base font-semibold tracking-tight text-zinc-700">
        {item.label}
      </span>
    </div>
  );
...
function MarqueeRow({
  ...
  return (
    <div
      ...
      style={
        {
          ["--marquee-duration" as string]: `${durationSeconds ?? 26}s`,
