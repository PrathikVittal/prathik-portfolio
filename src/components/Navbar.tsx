...
//                     <nav className="relative rounded-full border border-white/10 bg-white/[0.06] px-2 py-2 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] backdrop-blur-2xl">
...
//                                             {/* ✅ Hover liquid glass ONLY when not active */}
//                                             {!active && (
//                                                 <>
...
//                                             {/* ✅ Underline instead of dot (active only) */}
//                                             {active && (
//                                                 <span className="pointer-events-none absolute -bottom-2 left-1/2 h-[2px] w-8 -translate-x-1/2 rounded-full bg-white/90" />
//                                             )}
//                                         </Link>
//                                     </li>
//                                 );
